...
const Page = () => {
  return (
    <Box>
      ...
      <Space />
      <Typography variant="h2">CSS系</Typography>
      <Typography variant="h3">&lt;&gt;（空タグ, Fragment）</Typography>
  ...
  <div>要素2</div>
      ...
      />
      <Typography variant="h4">応用例</Typography>
      <CodePreview
  ...
  <>
    ...
    <div className="bg-green-300 p-2">B</div>
      ...
      />
      <Space />
      <Typography variant="h3">&lt;div&gt;</Typography>
      <Typography variant="h4">概要</Typography>
      <Typography>
  ...
  <div className="bg-green-300 p-2">B</div>
      ...
      />
      <Space />
      <Typography variant="h2">MUI系</Typography>
  ...
  <Box sx={{ p: 2, bgcolor: 'secondary.light' }}>B</Box>
      ...
      />
      <Space />
      <Typography variant="h2">まとめ：関係性と使い分け</Typography>
      <Typography>
